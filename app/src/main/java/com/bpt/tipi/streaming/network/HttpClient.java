...
public class HttpClient {
    ...
    //Avantel
    //public static final String URL = "http://10.126.0.229:8080/titan-live/api";

    //public static final String URL_ALT = "http://10.126.0.229:8081/Evidencias-RestAPI/api/v1";
    public static final String URL_ALT = "http://52.24.232.162:8085/Evidencias-RestAPI/api/v1";
